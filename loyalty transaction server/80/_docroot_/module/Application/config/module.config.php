...
return array(
    'router' => array(
        'routes' => array(
            ...
            'points' => array(
            		'type' => 'Segment',
            		'options' => array(
            				'route' => '/service/points[/:action]',
            				'constraints' => array(
            						'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
            				),
            				'defaults' => array(
            						'controller' => 'Application\Controller\Points',
            						'action'     => 'index',
            				),
            		),
            ),
            'transaction' => array(
            		'type' => 'Segment',
            		'options' => array(
            				'route' => '/service/transaction[/:action]',
            				'constraints' => array(
            						'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
            				),
            				'defaults' => array(
    ...
    'controllers' => array(
        'invokables' => array(
            ...
            'Application\Controller\Points' => 'Application\Controller\PointsController',
